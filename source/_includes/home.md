...
<p>
围绕复杂环境中声场调控的科学难题，长期从事声学人工结构的理论与应用研究。以第一或通讯作者（含共同）在 <em>Physical Review Letters</em>、<em>National Science Review</em>、<em>Science Advances</em>、<em>Nature Communications</em>、<em>Nature Reviews Materials</em>、<em>Nature Reviews Physics</em>、<em>Reports on Progress in Physics</em>、<em>Science Bulletin</em> 等期刊发表论文 110 余篇（其中14篇 ESI 高被引论文）。研究成果多次入选编辑推荐文章，并被 APS、AIP、Phys.org、Physics Buzz、Science Daily 等媒体专题报道。论文累计<a href="https://scholar.google.com/citations?user=KL5t7XoAAAAJ&hl"><em>被引用超过14,500次，H 因子54</em></a>，多次入选全球高被引学者及全球前2%顶尖科学家（生涯影响力）。曾获教育部自然科学奖一等奖、上海市声学学会“魏墨盦声学奖”，指导学生获中国国际大学生创新大赛全国金奖。超构吸声体相关专利已实现成果转化，应用大型压气机降噪系统，实现低噪声运行目标。
</p>
...
<strong class="normal">超构表面声场调控理论--“以小控大”：</strong>针对低频声场调控难题，将超构表面拓展至声学领域，实现了小尺寸结构调控低频声场；利用损耗自由度构建了非厄米声学超构表面，揭示了损耗在声场调控中的新内涵，为声学器件小型化提供了新方法。

<strong class="normal">超构表面宽带吸声理论--“由窄拓宽”：</strong>针对宽频声场调控难题，提出了弱吸声单元共振耦合新机理，揭示了耦合效应提升吸声带宽的新机制；制备了轻薄超构表面宽带吸声器件，实现了低频宽带声场的高效控制。

<strong class="normal">超构表面声衬降噪理论--“动中取静”：</strong>针对复杂环境声场调控难题，揭示了高速气流下多模态螺旋声波与超构表面作用机理，发展了超构表面声衬降噪新技术，解决了极端环境下的装备噪声控制问题。
-->
# 🧠 研究方向

## 1. 功能材料奇异声场调控
<p> 围绕人工结构与功能材料中的声场调控机制展开基础研究，探讨声波在复杂介质中的传播、干涉及局域化规律。研究聚焦于共振耦合、波前整形与非互易声传输等异常波动特性，力求阐明声场与材料相互作用的物理本质，为高精度声能操控与新型声学器件提供理论依据与设计思路。</p>  
...
## 2. 声学功能材料应用探索
<p> 面向装备的噪声控制与声学性能优化需求，开展声学功能材料的应用基础研究。重点推进基于深亚波长结构的高性能吸声超构材料与多功能复合体系设计，系统分析共振、耦合、干涉及耗散机制下的声学能量管理规律。研究目标在于实现宽频、高效、轻量化与可编程的吸隔声方案，支撑交通、航空航天与精密声学工程等领域的技术创新。</p>  
...
## 3. 非厄米声学及拓扑声学
<p> 聚焦非厄米物理与拓扑声学的交叉前沿，系统研究增益/损耗调控、奇异点（EP）及拓扑边缘态的声学实现与动力学特征。重点揭示非互易声传播、模态耦合非对称性及能量传输鲁棒性等新型物理规律。通过构建非厄米拓扑结构与非互易声波通道，推动高鲁棒声通信、可重构声场操控与智能声学系统的发展。</p>
...
<strong class="normal">Theory of Acoustic Metasurface Manipulation — "Small Structures Controlling Large Fields":</strong> To address the challenge of low-frequency acoustic manipulation, Prof. Li extended metasurface concepts into acoustics, realizing the control of low-frequency sound fields with compact structures. By introducing loss degrees of freedom to construct non-Hermitian acoustic metasurfaces, he revealed new physical meanings of loss in acoustic control, providing new approaches for miniaturized acoustic devices.

<strong class="normal">Theory of Broadband Acoustic Absorption — "From Narrow to Broad":</strong> To solve the problem of broadband acoustic control, he proposed a new mechanism of resonant coupling among weakly absorbing units, revealing how coupling effects enhance absorption bandwidth. Lightweight and thin broadband acoustic metasurface absorbers were fabricated, achieving efficient control of low-frequency broadband acoustic fields.

<strong class="normal">Theory of Acoustic-Liner Noise Reduction -- "Silence in Motion":</strong>  To tackle acoustic control under complex flow environments, he uncovered the mechanism of multimodal helical sound waves interacting with metasurfaces under high-speed airflow and developed a new metasurface-based acoustic-liner noise-reduction technology, enabling effective noise control of equipment operating under extreme conditions.
-->
