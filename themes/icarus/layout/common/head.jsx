...
function getPageTitle(page, siteTitle, helper) {
    ...
    if (typeof title === 'string' && typeof siteTitle === 'string' && siteTitle.includes(title)) {
        return title;
    }
...
module.exports = class extends Component {
    render() {
        ...
        if (Array.isArray(config.widgets)) {
            ...
            if (widget) adsenseClientId = widget.client_id;
        }
        ...
        if (Array.isArray(config.widgets)) {
            ...
            if (widget) followItVerificationCode = widget.verification_code;
        }
        ...
        return <head>
            ...
            {fontCssUrl[variant] ? <link rel="stylesheet" href={fontCssUrl[variant]} /> : null}
